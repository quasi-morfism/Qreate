...
export async function updateApp(body: API.AppUpdateAdminRequest, options?: { [key: string]: any }) {
...
/** 此处后端没有提供注释 POST /app/selected/list/page/vo */
export async function listGoodAppVoByPage(
  body: API.AppQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageAppVO>('/app/selected/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
