...
public class CodeFileSaverExecutor {
    ...
    private static final HtmlFileCodeSaverTemplate htmlFileCodeSaver = new HtmlFileCodeSaverTemplate();
    ...
    public static File executeSaver(Object codeResult, CodeGenTypeEnum codeGenType, Long appId) {
        return switch (codeGenType) {
            case HTML -> htmlFileCodeSaver.saveCode((HtmlCodeResult) codeResult, appId);
